...
final Map<String, List<Iconf>> bottomStickers = {
  ...
  'assets/svgimage/fooditem/foodicon.png': [
    ...
    Iconf(type: ItemType.sticker, data: 'assets/svgimage/fooditem/bar_icecream'),
    ...
    Iconf(type: ItemType.sticker, data: 'assets/svgimage/fooditem/chicken_drumstick'),
    ...
    Iconf(type: ItemType.sticker, data: 'assets/svgimage/fooditem/cone_icecream'),
    ...
    Iconf(type: ItemType.sticker, data: 'assets/svgimage/fooditem/piece_of_cake'),
